...
PROMPT='${PR_BOLD_WHITE}%*${reset_color} ${PR_YELLOW}%n%{$reset_color%} %{$FG[239]%}@%{$reset_color%} ${PR_BLUE}$(box_name)%{$reset_color%} %{$FG[239]%}:%{$reset_color%} ${PR_CYAN}$(current_pwd)%{$reset_color%} $(git_prompt_string)
